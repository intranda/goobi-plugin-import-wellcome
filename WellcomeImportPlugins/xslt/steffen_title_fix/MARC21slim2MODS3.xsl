...
-->
		...
		<xsl:if test="$typeOf008='MP'">
			...
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-25='a' or $marc:controlfield008-25='b' or $marc:controlfield008-25='c' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='j']">
		...
		<originInfo>
			...
			<xsl:if test="($marc:controlfield008-6='e' or $marc:controlfield008-6='p' or $marc:controlfield008-6='r' or $marc:controlfield008-6='s' or $marc:controlfield008-6='t') and ($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
			...
			<xsl:if test="($marc:controlfield008-6='e' or $marc:controlfield008-6='p' or $marc:controlfield008-6='r' or $marc:controlfield008-6='s' or $marc:controlfield008-6='t') and not($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
				<xsl:if test="$marc:controlfield008-7-10 and ($marc:controlfield008-7-10 != $marc:datafield260c)">
			...
			<xsl:if test="$marc:controlfield008-6='c' or $marc:controlfield008-6='d' or $marc:controlfield008-6='i' or $marc:controlfield008-6='k' or $marc:controlfield008-6='m' or $marc:controlfield008-6='u'">
			...
			<xsl:for-each select="marc:controlfield[@tag=008]">
				...
				<frequency>
					<xsl:choose>
						<xsl:when test="$marc:controlfield008-18='a'">Annual</xsl:when>
						<xsl:when test="$marc:controlfield008-18='b'">Bimonthly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='c'">Semiweekly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='d'">Daily</xsl:when>
						<xsl:when test="$marc:controlfield008-18='e'">Biweekly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='f'">Semiannual</xsl:when>
						<xsl:when test="$marc:controlfield008-18='g'">Biennial</xsl:when>
						<xsl:when test="$marc:controlfield008-18='h'">Triennial</xsl:when>
						<xsl:when test="$marc:controlfield008-18='i'">Three times a week</xsl:when>
						<xsl:when test="$marc:controlfield008-18='j'">Three times a month</xsl:when>
						<xsl:when test="$marc:controlfield008-18='k'">Continuously updated</xsl:when>
						<xsl:when test="$marc:controlfield008-18='m'">Monthly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='q'">Quarterly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='s'">Semimonthly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='t'">Three times a year</xsl:when>
						<xsl:when test="$marc:controlfield008-18='u'">Unknown</xsl:when>
						<xsl:when test="$marc:controlfield008-18='w'">Weekly</xsl:when>
						<xsl:when test="$marc:controlfield008-18='#'">Completely irregular</xsl:when>
					</xsl:choose>
				</frequency>
			</xsl:for-each>
		</originInfo>
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:choose>
				...
				<xsl:when test="($marc:controlfield008-23=' ' and ($leader6='c' or $leader6='d')) or (($typeOf008='BK' or $typeOf008='SE') and ($marc:controlfield008-23=' ' or $marc:controlfield008='r'))">
	...
	<xsl:template name="nameABCDN">
		...
		<namePart>
			...
			<xsl:if test="marc:subfield[@code='a'] or marc:subfield[@code='c'] or marc:subfield[@code='d'] or marc:subfield[@code='n']">
				<xsl:call-template name="specialsubfieldSelect">
						<xsl:with-param name="axis">a</xsl:with-param>
						<xsl:with-param name="anyCodes">acdn</xsl:with-param>
<!-- 						<xsl:with-param name="beforeCodes">cdn</xsl:with-param> -->
	...
	<xsl:template name="nameABCDNPQ">
		<namePart>
			<xsl:call-template name="subfieldSelect">
				<xsl:with-param name="codes">abcdnpq</xsl:with-param>
			</xsl:call-template>
		</namePart>
	</xsl:template>
				...
				<url displayLabel="electronic resource">
					...
					<xsl:variable name="primary">
						<xsl:choose>
							...
							<xsl:when test="@ind2=1 and         count(ancestor::record//marc:datafield[@tag=856][@ind2=0])=0 and         count(preceding-sibling::marc:datafield[@tag=856][@ind2=1])=0">true</xsl:when>

							<xsl:when test="@ind2!=1 and @ind2!=0 and         @ind2!=2 and count(ancestor::record//marc:datafield[@tag=856 and         @ind2=0])=0 and count(ancestor::record//marc:datafield[@tag=856 and         @ind2=1])=0 and         count(preceding-sibling::marc:datafield[@tag=856][@ind2])=0">true</xsl:when>

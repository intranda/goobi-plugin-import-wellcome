<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink"
	...
	<xsl:template name="marcRecord">
		...
		<xsl:variable name="marc:controlfield008" select="marc:controlfield[@tag='008']" />
		...
		<xsl:for-each select="marc:datafield[@tag='242']">
			<titleInfo type="translated">
				<!--09/01/04 Added marc:subfield $y -->
		...
		<!--old 7XXs <xsl:for-each select="marc:datafield[@tag='700'][not(marc:subfield[@code='t'])]"> <name type="personal"> <xsl:call-template name="nameABCDQ"/> 
			<xsl:call-template name="affiliation"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="marc:datafield[@tag='710'][not(marc:subfield[@code='t'])]"> 
			<name type="corporate"> <xsl:call-template name="nameABCDN"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="marc:datafield[@tag='711'][not(marc:subfield[@code='t'])]"> 
			<name type="conference"> <xsl:call-template name="nameACDEQ"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="marc:datafield[@tag='720'][not(marc:subfield[@code='t'])]"> 
			<name> <xsl:if test="@ind1=1"> <xsl:attribute name="type"> <xsl:text>personal</xsl:text> </xsl:attribute> </xsl:if> <namePart> <xsl:value-of select="marc:subfield[@code='a']"/> 
			</namePart> <xsl:call-template name="role"/> </name> </xsl:for-each> -->

		<typeOfResource>
			<xsl:choose>
				<xsl:when test="$leader6='a'">Monographic</xsl:when>
				<xsl:when test="$leader6='b'">continuing</xsl:when>
				<xsl:when test="$leader6='c'">Notated music</xsl:when>
				<xsl:when test="$leader6='d'">Manuscript notated music</xsl:when>
				<xsl:when test="$leader6='e'">Cartographic material</xsl:when>
				<xsl:when test="$leader6='f'">Manuscript cartographic material</xsl:when>
				<xsl:when test="$leader6='g'">Projected medium</xsl:when>
				<xsl:when test="$leader6='i'">Nonmusical sound recording</xsl:when>
				<xsl:when test="$leader6='j'">Musical sound recording</xsl:when>
				<xsl:when test="$leader6='k'">wo-dimensional nonprojectable graphic</xsl:when>
				...
				<xsl:when test="$leader6='r'">Three-dimensional artefact or naturally occurring object</xsl:when>
				<xsl:when test="$leader6='t'">Manuscript language material</xsl:when>
			</xsl:choose>
		</typeOfResource>



		<xsl:if test="substring($marc:controlfield008,26,1)='d'">
		...
		<xsl:if test="$typeOf008='MP'">
			<xsl:variable name="marc:controlfield008-25" select="substring($marc:controlfield008,26,1)" />
			<xsl:choose>
				<xsl:when
					test="$marc:controlfield008-25='a' or $marc:controlfield008-25='b' or $marc:controlfield008-25='c' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='j']">
					<genre authority="marcgt">map</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-25='e' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='d']">
					<genre authority="marcgt">atlas</genre>
				</xsl:when>
			</xsl:choose>
		</xsl:if>
		<xsl:if test="$typeOf008='SE'">
			<xsl:variable name="marc:controlfield008-21" select="substring($marc:controlfield008,22,1)" />
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-21='d'">
					<genre authority="marcgt">database</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-21='l'">
					<genre authority="marcgt">loose-leaf</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-21='m'">
					<genre authority="marcgt">series</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-21='n'">
					<genre authority="marcgt">newspaper</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-21='p'">
					<genre authority="marcgt">periodical</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-21='w'">
					<genre authority="marcgt">web site</genre>
				</xsl:when>
			</xsl:choose>
		</xsl:if>
		<xsl:if test="$typeOf008='BK' or $typeOf008='SE'">
			<xsl:variable name="marc:controlfield008-24" select="substring($marc:controlfield008,25,4)" />
			<xsl:choose>
				<xsl:when test="contains($marc:controlfield008-24,'a')">
					<genre authority="marcgt">abstract or summary</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'b')">
					<genre authority="marcgt">bibliography</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'c')">
					<genre authority="marcgt">catalog</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'d')">
					<genre authority="marcgt">dictionary</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'e')">
					<genre authority="marcgt">encyclopedia</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'f')">
					<genre authority="marcgt">handbook</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'g')">
					<genre authority="marcgt">legal article</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'i')">
					<genre authority="marcgt">index</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'k')">
					<genre authority="marcgt">discography</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'l')">
					<genre authority="marcgt">legislation</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'m')">
					<genre authority="marcgt">theses</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'n')">
					<genre authority="marcgt">survey of literature</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'o')">
					<genre authority="marcgt">review</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'p')">
					<genre authority="marcgt">programmed text</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'q')">
					<genre authority="marcgt">filmography</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'r')">
					<genre authority="marcgt">directory</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'s')">
					<genre authority="marcgt">statistics</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'t')">
					<genre authority="marcgt">technical report</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'v')">
					<genre authority="marcgt">legal case and case notes</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'w')">
					<genre authority="marcgt">law report or digest</genre>
				</xsl:when>
				<xsl:when test="contains($marc:controlfield008-24,'z')">
					<genre authority="marcgt">treaty</genre>
				</xsl:when>
			</xsl:choose>
			<xsl:variable name="marc:controlfield008-29" select="substring($marc:controlfield008,30,1)" />
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-29='1'">
					<genre authority="marcgt">conference publication</genre>
				</xsl:when>
			</xsl:choose>
		</xsl:if>
		<xsl:if test="$typeOf008='CF'">
			<xsl:variable name="marc:controlfield008-26" select="substring($marc:controlfield008,27,1)" />
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-26='a'">
					<genre authority="marcgt">numeric data</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-26='e'">
					<genre authority="marcgt">database</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-26='f'">
					<genre authority="marcgt">font</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-26='g'">
					<genre authority="marcgt">game</genre>
				</xsl:when>
			</xsl:choose>
		</xsl:if>
		<xsl:if test="$typeOf008='BK'">
			<xsl:if test="substring($marc:controlfield008,25,1)='j'">
				<genre authority="marcgt">patent</genre>
			</xsl:if>
			<xsl:if test="substring($marc:controlfield008,25,1)='2'">
				<genre authority="marcgt">offprint</genre>
			</xsl:if>
			<xsl:if test="substring($marc:controlfield008,31,1)='1'">
				<genre authority="marcgt">festschrift</genre>
			</xsl:if>
			<xsl:variable name="marc:controlfield008-34" select="substring($marc:controlfield008,35,1)" />
			<xsl:if test="$marc:controlfield008-34='a' or $marc:controlfield008-34='b' or $marc:controlfield008-34='c' or $marc:controlfield008-34='d'">
				<genre authority="marcgt">biography</genre>
			</xsl:if>
			<xsl:variable name="marc:controlfield008-33" select="substring($marc:controlfield008,34,1)" />
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-33='e'">
					<genre authority="marcgt">essay</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='d'">
					<genre authority="marcgt">drama</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='c'">
					<genre authority="marcgt">comic strip</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='l'">
					<genre authority="marcgt">fiction</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='h'">
					<genre authority="marcgt">humor, satire</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='i'">
					<genre authority="marcgt">letter</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='f'">
					<genre authority="marcgt">novel</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='j'">
					<genre authority="marcgt">short story</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='s'">
					<genre authority="marcgt">speech</genre>
				</xsl:when>
			</xsl:choose>
		</xsl:if>
		<xsl:if test="$typeOf008='MU'">
			<xsl:variable name="marc:controlfield008-30-31" select="substring($marc:controlfield008,31,2)" />
			<xsl:if test="contains($marc:controlfield008-30-31,'b')">
				<genre authority="marcgt">biography</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'c')">
				<genre authority="marcgt">conference publication</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'d')">
				<genre authority="marcgt">drama</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'e')">
				<genre authority="marcgt">essay</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'f')">
				<genre authority="marcgt">fiction</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'o')">
				<genre authority="marcgt">folktale</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'h')">
				<genre authority="marcgt">history</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'k')">
				<genre authority="marcgt">humor, satire</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'m')">
				<genre authority="marcgt">memoir</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'p')">
				<genre authority="marcgt">poetry</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'r')">
				<genre authority="marcgt">rehearsal</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'g')">
				<genre authority="marcgt">reporting</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'s')">
				<genre authority="marcgt">sound</genre>
			</xsl:if>
			<xsl:if test="contains($marc:controlfield008-30-31,'l')">
				<genre authority="marcgt">speech</genre>
			</xsl:if>
		</xsl:if>
		<xsl:if test="$typeOf008='VM'">
			<xsl:variable name="marc:controlfield008-33" select="substring($marc:controlfield008,34,1)" />
			<xsl:choose>
				<xsl:when test="$marc:controlfield008-33='a'">
					<genre authority="marcgt">art original</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='b'">
				...
				<xsl:when test="$marc:controlfield008-33='g'">
					<genre authority="marcgt">legal article</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='i'">
					<genre authority="marcgt">picture</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='k'">
					<genre authority="marcgt">graphic</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='l'">
					<genre authority="marcgt">technical drawing</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='m'">
					<genre authority="marcgt">motion picture</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='n'">
					<genre authority="marcgt">chart</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='o'">
					<genre authority="marcgt">flash card</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='p'">
					<genre authority="marcgt">microscope slide</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='q' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='q']">
					<genre authority="marcgt">model</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='r'">
					<genre authority="marcgt">realia</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='s'">
					<genre authority="marcgt">slide</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='t'">
					<genre authority="marcgt">transparency</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='v'">
					<genre authority="marcgt">videorecording</genre>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-33='w'">
		...
		<originInfo>
			...
			<xsl:variable name="MARCpublicationCode" select="normalize-space(substring($marc:controlfield008,16,3))" />
			...
			<xsl:variable name="marc:datafield260c">
				<xsl:call-template name="chopPunctuation">
					<xsl:with-param name="chopString" select="marc:datafield[@tag=260]/marc:subfield[@code='c']" />
				</xsl:call-template>
			</xsl:variable>
			<xsl:variable name="marc:controlfield008-7-10" select="normalize-space(substring($marc:controlfield008, 8, 4))" />
			<xsl:variable name="marc:controlfield008-11-14" select="normalize-space(substring($marc:controlfield008, 12, 4))" />
			<xsl:variable name="marc:controlfield008-6" select="normalize-space(substring($marc:controlfield008, 7, 1))" />

			<!-- tmee 1.35 and 1.36 -->

			<xsl:if
				test="($marc:controlfield008-6='e' or $marc:controlfield008-6='p' or $marc:controlfield008-6='r' or $marc:controlfield008-6='s' or $marc:controlfield008-6='t') and ($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
				<xsl:if test="$marc:controlfield008-7-10 and ($marc:controlfield008-7-10 != $marc:datafield260c)">
					<dateCreated encoding="marc">
						<xsl:value-of select="concat($marc:controlfield008-7-10, $marc:controlfield008-11-14)" />
					</dateCreated>
				</xsl:if>
			</xsl:if>

			<xsl:if
				test="($marc:controlfield008-6='e' or $marc:controlfield008-6='p' or $marc:controlfield008-6='r' or $marc:controlfield008-6='s' or $marc:controlfield008-6='t') and not($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
				<xsl:if test="$marc:controlfield008-7-10 and ($marc:controlfield008-7-10 != $marc:datafield260c)">
			...
			<xsl:if
				test="$marc:controlfield008-6='c' or $marc:controlfield008-6='d' or $marc:controlfield008-6='i' or $marc:controlfield008-6='k' or $marc:controlfield008-6='m' or $marc:controlfield008-6='u'">
				<xsl:if test="$marc:controlfield008-7-10">
					<dateIssued encoding="marc" point="start">
						<xsl:value-of select="$marc:controlfield008-7-10" />
					</dateIssued>
				</xsl:if>
			</xsl:if>
			...
			<xsl:if
				test="$marc:controlfield008-6='c' or $marc:controlfield008-6='d' or $marc:controlfield008-6='i' or $marc:controlfield008-6='k' or $marc:controlfield008-6='m' or $marc:controlfield008-6='u'">
				<xsl:if test="$marc:controlfield008-11-14">
					<dateIssued encoding="marc" point="end">
						<xsl:value-of select="$marc:controlfield008-11-14" />
					</dateIssued>
				</xsl:if>
			</xsl:if>

			<xsl:if test="$marc:controlfield008-6='q'">
				<xsl:if test="$marc:controlfield008-7-10">
			...
			<xsl:if test="$marc:controlfield008-6='t'">
				<xsl:if test="$marc:controlfield008-11-14">
			...
			<xsl:for-each select="leader">
				<issuance>
					<xsl:choose>
						...
						<xsl:when test="$leader7='c'">
							Notated music
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='d'">
							Manuscript notated music
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='e'">
							Cartographic material
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='f'">
							Manuscript cartographic material
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='g'">
							Projected medium
						</xsl:when><!-- Video -->
						<xsl:when test="$leader7='i'">
							Nonmusical sound recording
						</xsl:when><!-- Audio -->
						<xsl:when test="$leader7='j'">
							Musical sound recording
						</xsl:when><!-- Audio -->
						<xsl:when test="$leader7='k'">
							Two-dimensional nonprojectable graphic
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='m'">
							Computer file
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='o'">
							Kit
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='p'">
							Mixed materials
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='r'">
							Three-dimensional artefact or naturally occurring object
						</xsl:when><!-- Monograph -->
						<xsl:when test="$leader7='t'">
							Manuscript language material
						</xsl:when><!-- Archive -->
						<!-- <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">monographic</xsl:when> <xsl:when test="$leader7='b'">continuing</xsl:when> 
							<xsl:when test="$leader7='m' and ($leader19='a' or $leader19='b' or $leader19='c')">multipart monograph</xsl:when> <xsl:when test="$leader7='m' and ($leader19='#')">single 
							unit</xsl:when> <xsl:when test="$leader7='i'">integrating resource</xsl:when> <xsl:when test="$leader7='s'">serial</xsl:when> -->
					</xsl:choose>
				</issuance>
			</xsl:for-each>
			...
			<xsl:for-each select="marc:controlfield[@tag=008]">
				<xsl:variable name="marc:controlfield008-18" select="substring($marc:controlfield008,19,1)" />
				<frequency>
					<xsl:choose>
						<xsl:when test="$marc:controlfield008-18='a'">
							Annual
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='b'">
							Bimonthly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='c'">
							Semiweekly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='d'">
							Daily
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='e'">
							Biweekly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='f'">
							Semiannual
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='g'">
							Biennial
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='h'">
							Triennial
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='i'">
							Three times a week
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='j'">
							Three times a month
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='k'">
							Continuously updated
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='m'">
							Monthly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='q'">
							Quarterly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='s'">
							Semimonthly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='t'">
							Three times a year
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='u'">
							Unknown
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='w'">
							Weekly
						</xsl:when>
						<xsl:when test="$marc:controlfield008-18='#'">
		...
		<!-- 041 -->
		<xsl:variable name="marc:controlfield008-35-37" select="normalize-space(translate(substring($marc:controlfield008,36,3),'|#',''))" />
		<xsl:if test="$marc:controlfield008-35-37">
			<language>
				<languageTerm authority="iso639-2b" type="code">
					<xsl:value-of select="substring($marc:controlfield008,36,3)" />
				</languageTerm>
			</language>
		</xsl:if>
				...
				<xsl:choose>
					<xsl:when test="../marc:subfield[@code='2']='rfc3066'">
						...
						<xsl:call-template name="rfcLanguages">
							...
							<xsl:with-param name="marc:controlfield008-35-37">
								<xsl:value-of select="$marc:controlfield008-35-37" />
							</xsl:with-param>
						</xsl:call-template>
					</xsl:when>
					<xsl:otherwise>
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:variable name="marc:controlfield008-23" select="substring($marc:controlfield008,24,1)" />
			<xsl:variable name="marc:controlfield008-29" select="substring($marc:controlfield008,30,1)" />
			...
			<xsl:choose>
				<xsl:when test="($check008-23 and $marc:controlfield008-23='f') or ($check008-29 and $marc:controlfield008-29='f')">
					<form authority="marcform">braille</form>
				</xsl:when>
				<xsl:when
					test="($marc:controlfield008-23=' ' and ($leader6='c' or $leader6='d')) or (($typeOf008='BK' or $typeOf008='SE') and ($marc:controlfield008-23=' ' or $marc:controlfield008='r'))">
					<form authority="marcform">print</form>
				</xsl:when>
				<xsl:when test="$leader6 = 'm' or ($check008-23 and $marc:controlfield008-23='s') or ($check008-29 and $marc:controlfield008-29='s')">
				...
				<xsl:when test="($check008-23 and $marc:controlfield008-23='b') or ($check008-29 and $marc:controlfield008-29='b')">
					<form authority="marcform">microfiche</form>
				</xsl:when>
				<xsl:when test="($check008-23 and $marc:controlfield008-23='a') or ($check008-29 and $marc:controlfield008-29='a')">
		...
		<xsl:if test="$typeOf008='BK' or $typeOf008='CF' or $typeOf008='MU' or $typeOf008='VM'">
			<xsl:variable name="marc:controlfield008-22" select="substring($marc:controlfield008,23,1)" />
			<xsl:choose>
				<!-- 01/04 fix -->
				<xsl:when test="$marc:controlfield008-22='d'">
					<targetAudience authority="marctarget">adolescent</targetAudience>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-22='e'">
					<targetAudience authority="marctarget">adult</targetAudience>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-22='g'">
					<targetAudience authority="marctarget">general</targetAudience>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-22='b' or $marc:controlfield008-22='c' or $marc:controlfield008-22='j'">
					<targetAudience authority="marctarget">juvenile</targetAudience>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-22='a'">
					<targetAudience authority="marctarget">preschool</targetAudience>
				</xsl:when>
				<xsl:when test="$marc:controlfield008-22='f'">
					<targetAudience authority="marctarget">specialized</targetAudience>
				</xsl:when>
			</xsl:choose>
		</xsl:if>

		<!-- 1.32 tmee Drop note mapping for 510 and map only to <relatedItem> <xsl:for-each select="marc:datafield[@tag=510]"> <note type="citation/reference"> 
			<xsl:call-template name="uri"/> <xsl:variable name="str"> <xsl:for-each select="marc:subfield[@code!='6' or @code!='8']"> <xsl:value-of select="."/> <xsl:text> 
			</xsl:text> </xsl:for-each> </xsl:variable> <xsl:value-of select="substring($str,1,string-length($str)-1)"/> </note> </xsl:for-each> -->
			...
			<xsl:if
				...
				<identifier>
					<xsl:attribute name="type">
						...
						<xsl:if
						test="starts-with(marc:subfield[@code='u'],'urn:hdl') or starts-with(marc:subfield[@code='u'],'hdl') or starts-with(marc:subfield[@code='u'],'http://hdl.loc.gov')">hdl</xsl:if>
					</xsl:attribute>
		...
		<recordInfo>
			...
			<!-- Wellcome internal identifier2 945 a -->
	...
	<xsl:template name="nameABCDEN">
		<namePart>
			...
			<xsl:text>: </xsl:text>
			<xsl:if test="marc:subfield[@code='a'] or marc:subfield[@code='c'] or marc:subfield[@code='d'] or marc:subfield[@code='n']">
				<xsl:call-template name="specialsubfieldSelect">
					<xsl:with-param name="axis">
						a
					</xsl:with-param>
					...
					<!-- <xsl:with-param name="beforeCodes">cdn</xsl:with-param> -->
				</xsl:call-template>
			</xsl:if>
		</namePart>
	</xsl:template>
	...
	<!-- isInvalid <xsl:template name="isInvalid"> <xsl:param name="type"/> <xsl:if test="marc:subfield[@code='z'] or marc:subfield[@code='y'] or marc:subfield[@code='m']"> 
		...
		<xsl:if test="marc:subfield[@code='z']"> <xsl:value-of select="marc:subfield[@code='z']"/> </xsl:if> <xsl:if test="marc:subfield[@code='y']"> <xsl:value-of 
		select="marc:subfield[@code='y']"/> </xsl:if> <xsl:if test="marc:subfield[@code='m']"> <xsl:value-of select="marc:subfield[@code='m']"/> </xsl:if> </identifier> 
		</xsl:if> </xsl:template> -->
	...
	<xsl:template name="getLanguage">
		...
		<xsl:param name="marc:controlfield008-35-37" />
		<xsl:variable name="length" select="string-length($langString)" />
		<xsl:choose>
			<xsl:when test="$length=0" />
			<xsl:when test="$marc:controlfield008-35-37=substring($langString,1,3)">
				<xsl:call-template name="getLanguage">
					<xsl:with-param name="langString" select="substring($langString,4,$length)" />
					<xsl:with-param name="marc:controlfield008-35-37" select="$marc:controlfield008-35-37" />
				</xsl:call-template>
			</xsl:when>
			<xsl:otherwise>
				<language>
	...
	<xsl:template name="rfcLanguages">
		...
		<xsl:choose>
			...
			<xsl:when test="$currentLanguage!=$marc:controlfield008-35-37 and $currentLanguage!='rfc3066'">
	...
	<xsl:template match="marc:datafield" mode="trans880">
		<xsl:variable name="marc:datafield880" select="//marc:datafield" />
		<xsl:variable name="sf06" select="normalize-space(marc:subfield[@code='6'])" />
		<xsl:variable name="sf06a" select="substring($sf06, 1, 3)" />
	...
	<xsl:template name="createTitleInfoFrom245">
		<titleInfo>
			...
			<!-- <xsl:choose> <xsl:when test="@ind2&gt;0"> <xsl:if test="@tag!='880'"> <nonSort> <xsl:value-of select="substring($titleChop,1,@ind2)"/> </nonSort> 
				</xsl:if> <title> <xsl:value-of select="substring($titleChop,@ind2+1)"/> </title> </xsl:when> <xsl:otherwise> -->
			<title>
				<xsl:value-of select="$titleChop" />
			</title>
	...
	<xsl:template name="createNameFrom110">
		<name type="corporate">
			...
			<xsl:call-template name="nameABCDEN" />
			<xsl:call-template name="role" />
		</name>
	</xsl:template>
	...
	<xsl:template name="createNameFrom111">
		<name type="conference">
			...
			<xsl:call-template name="nameABCDNPQ" />
			<xsl:call-template name="role" />
		</name>
	</xsl:template>

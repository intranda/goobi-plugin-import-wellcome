 ...
 -->
		...
		<typeOfResource>
			<xsl:choose>
				...
				<xsl:when test="$leader6='b'">
					continuing
				</xsl:when>
				<xsl:when test="$leader6='c'">
					Notated music
				</xsl:when>
				<xsl:when test="$leader6='d'">
					Manuscript notated music
				</xsl:when>
				<xsl:when test="$leader6='e'">
					Cartographic material
				</xsl:when>
				<xsl:when test="$leader6='f'">
		...
		<!-- <xsl:call-template name="createTimeFrom306" /> -->
		<!-- </xsl:for-each> -->
	...
	<xsl:template name="specialsubfieldSelect">
		...
		<xsl:variable name="str">
			<xsl:for-each select="marc:subfield">
				<!-- <xsl:value-of select="text()" /> -->
				<!-- <xsl:if test="contains($anyCodes, @code)">11</xsl:if> -->
				<!-- <xsl:if test="contains($beforeCodes,@code)">22</xsl:if> -->
				<!-- <xsl:if test="following-sibling::marc:subfield[@code=$axis]">33</xsl:if> -->
				<!-- <xsl:if test="contains($beforeCodes,@code) and following-sibling::marc:subfield[@code=$axis]">4 </xsl:if> -->
				<!-- <xsl:if test="contains($afterCodes,@code)">55 </xsl:if> -->
				<!-- <xsl:if test="preceding-sibling::marc:subfield[@code=$axis]">66 </xsl:if> -->
				<!-- <xsl:if test="contains($afterCodes,@code) and preceding-sibling::marc:subfield[@code=$axis]">77 </xsl:if> -->

...
public class WellcomeMilleniumImport implements IImportPlugin, IPlugin {

	/** Logger for this class. */
	private static final Logger logger = Logger.getLogger(WellcomeMilleniumImport.class);

	private static final String NAME = "Wellcome Millenium Import";
	private static final String VERSION = "0.0";
	private static final String MAPPING_FILE = ConfigMain.getParameter("KonfigurationVerzeichnis") + "WellcomeMillenium_map.properties";
	...
	public static void main(String[] args) throws PreferencesException, WriteException {
		WellcomeMilleniumImport wci = new WellcomeMilleniumImport();
